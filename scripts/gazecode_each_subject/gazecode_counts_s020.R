...
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s020_part2_data.xlsx"
...
category_counts(subjnum,1,"study",136,	166)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",271	,361)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",532,	566)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",702,	770)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",943	,964)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1049,	1169)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1317,	1340)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1439,	1505)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1648,	1670)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1775,	1851)
...
category_counts(subjnum,6,"study",61,	84)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",184,	260)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",461,	485)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",596,	673)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",877,	901)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",981,	1053)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1199,	1223)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1326,	1399)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1538	,1560)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1639	,1725)
...
sink("subject_020_gazeCodeCounts.csv")
