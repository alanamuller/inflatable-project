...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s031_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s031_part2_data.xlsx"
...
category_counts(subjnum,1,"retrieval",384	,518)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",818,	851)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",1007,	1131)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1301,	1339)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1442,	1495)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1666,	1700)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1809,	1881)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2019,	2055)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2209,	2306)
...
category_counts(subjnum,6,"study",128	,162)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",327	,446)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",613	,648)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",756	,837)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",1000,	1035)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1138,	1219)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1365,	1399)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1531,	1631)
...
category_counts(subjnum,10,"study",106,	141)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",240,	310)
...
sink("subject_031_gazeCodeCounts.csv")
