...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s028_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s028_part2_data.xlsx"
...
category_counts(subjnum,1,"study",204	,237)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",416	,656)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",892	,926)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",1079,	1190)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1363,	1398)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1498,	1635)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1865,	1898)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",2013,	2120)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2290,	2327)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2452,	2624)
...
category_counts(subjnum,6,"study",122,	157)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",286,	391)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",558,	593)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",684	,798)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",979,	1013)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1119,	1245)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1429,	1463)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1582,	1692)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1843,	1878)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1977,	2107)
...
sink("subject_028_gazeCodeCounts.csv")
