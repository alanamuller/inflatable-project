...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s012_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s012_part2_data.xlsx"
...
category_counts(subjnum,1,"study",183	,218)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",328,	461)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",654,	688)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",789,	900)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1061,	1094)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1196,	1324)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1481,	1515)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1614,	1745)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1886,	1919)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1988,	2094)
...
category_counts(subjnum,6,"study",35,	69)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",169,	299)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",451,	487)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",579,	673)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",873,	908)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",995	,1103)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1252,	1286)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1382,	1488)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1649	,1685)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1758	,1874)
...
sink("subject_012_gazeCodeCounts.csv")
