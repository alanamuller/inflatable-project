...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s014_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s014_part2_data.xlsx"
...
category_counts(subjnum,1,"study",195,	234)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",342,	441)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",645,	680)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",786,	871)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1076,	1110)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1232	,1326)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1478,	1512)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1628,	1705)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1871,	1906)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2028,	2111)
...
category_counts(subjnum,6,"study",37,	71)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",173	,247)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",396	,430)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",537	,621)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",772,	808)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",886,	954)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1157,	1192)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1293,	1387)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1549,	1582)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1673	,1775)
...
sink("subject_014_gazeCodeCounts.csv")
