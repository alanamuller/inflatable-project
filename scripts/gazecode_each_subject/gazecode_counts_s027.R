...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s027_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s027_part2_data.xlsx"
...
category_counts(subjnum,1,"study",180,	217)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",34,7	468)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",687,	722)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",853,	977)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1152,	1188)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1287	,1370)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1541,	1576)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1675,	1755)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1903,	1939)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2055,	2129)
...
category_counts(subjnum,6,"study",118	,151)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",236	,318)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",469	,504)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",600,	702)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",868	,904)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",992	,1085)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1245,	1281)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1375,	1487)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1618,	1652)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1754	,1832)
...
sink("subject_027_gazeCodeCounts.csv")
