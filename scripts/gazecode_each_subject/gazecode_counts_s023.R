...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s023_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s023_part2_data.xlsx"
...
category_counts(subjnum,1,"study",218	,253)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",406,	509)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",718	,752)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",842,	950)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1107,	1141)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1238	,1330)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1512	,1544)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1645,	1759)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1954,	1988)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2079,	2177)
...
category_counts(subjnum,6,"study",50,	83)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",174,	265)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",420,	453)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",567,	697)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",898	,931)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1023,	1108)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1252	,1285)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1376,	1462)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1630,	1665)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1771,	1850)
...
sink("subject_023_gazeCodeCounts.csv")
