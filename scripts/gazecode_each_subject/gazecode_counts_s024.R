...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s024_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s024_part2_data.xlsx"
...
category_counts(subjnum,1,"study",142,	177)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",296	,425)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",698,	733)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",833,	921)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1078,	1113)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1203,	1315)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1452,	1487)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1588,	1670)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1808,	1843)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1925,	2035)
...
category_counts(subjnum,6,"study",113,	147)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",224	,345)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",495,	531)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",620,	717)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",876,	913)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1009,	1116)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1333,	1367)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1457,	1555)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1715	,1748)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1850,	1958)
...
sink("subject_024_gazeCodeCounts.csv")
