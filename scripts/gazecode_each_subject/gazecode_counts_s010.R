...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s010_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s010_part2_data.xlsx"
data_part3 <- "D:/Nav_1stYr_project_data/GazeCode data/s010_part3_data.xlsx"
...
category_counts(subjnum,1,"study",136	,173)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",356,	553)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",819,	855)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",965	,1134)
...
category_counts(subjnum,3,"study",40,	81)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",223,	342)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",482,	519)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",599,	723)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",932,	966)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1088,	1176)
...
category_counts(subjnum,6,"study",85,	123)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",252,	418)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",604,	640)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",740	,849)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",997	,1032)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1159,	1245)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1405,	1441)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1523,	1646)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1800	,1836)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1926	,2044)
...
sink("subject_010_gazeCodeCounts.csv")
