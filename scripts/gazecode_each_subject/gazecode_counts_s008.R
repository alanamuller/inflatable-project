...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s008_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s008_part2_data.xlsx"
...
category_counts(subjnum,1,"study",136,	170)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",337,	473)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",681	,714)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",850,	933)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1149,	1184)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1288,	1361)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1549,	1583)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1658,	1746)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1898,	1932)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2035,	2114)
...
category_counts(subjnum,6,"study",50,	84)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",165,	274)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",440,	472)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",575,	696)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",865,	897)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",980,	1067)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1261,	1294)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1392,	1462)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1650,	1682)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1761,	1853)
...
sink("subject_008_gazeCodeCounts.csv")
