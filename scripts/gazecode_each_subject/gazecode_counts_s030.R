...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s030_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s030_part2_data.xlsx"
...
category_counts(subjnum,1,"study",164,	200)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",308,	438)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",637,	672)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",774,	918)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1076,	1110)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1234,	1388)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1529,	1563)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1691,	1835)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1979,	2013)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2105,	2295)
...
category_counts(subjnum,6,"study",55,	89)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",200	,338)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",506	,539)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",638	,729)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",886	,920)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1033,	1167)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1324,	1357)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1462,	1540)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1712,	1746)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1849	,1992)
...
sink("subject_030_gazeCodeCounts.csv")
