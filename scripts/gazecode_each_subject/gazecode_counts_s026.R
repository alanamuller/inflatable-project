...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s026_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s026_part2_data.xlsx"
...
category_counts(subjnum,1,"study",188,	222)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",443	,573)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",882,	916)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",1011,	1144)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1325,	1359)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1554,	1663)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1838,	1871)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1979,	2083)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2260,	2295)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2405,	2518)
...
category_counts(subjnum,6,"study",147,	183)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",317,	460)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",634,	670)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",769,	868)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",1038,	1072)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1214,	1332)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1501,	1535)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1649	,1761)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1951,	1985)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",2094	,2195)
...
sink("subject_026_gazeCodeCounts.csv")
