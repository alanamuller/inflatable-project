...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s029_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s029_part2_data.xlsx"
...
category_counts(subjnum,1,"study",214,	248)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",434,	602)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",833	,869)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",980	,1065)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1239,	1275)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1367,	1462)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1618,	1653)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1751,	1851)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2009,	2044)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2139,	2239)
...
category_counts(subjnum,6,"study",171	,207)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",351	,434)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",607	,644)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",729,	823)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",971	,1008)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1102,	1176)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1346,	1379)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1462,	1518)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1656,	1695)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1782,	1925)
...
sink("subject_029_gazeCodeCounts.csv")
