...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s017_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s017_part2_data.xlsx"
...
category_counts(subjnum,1,"study",131,	168)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",257,	410)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",613,	651)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",740	,893)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1040,	1073)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1163,	1321)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1477	,1511)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1602,	1712)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1855,	1891)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2007,	2220)
...
category_counts(subjnum,6,"study",120,	156)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",248,	330)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",495,	528)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",619,	740)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",889,	922)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",992,	1090)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1234,	1269)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1369,	1455)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1603,	1637)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1721	,1832)
...
sink("subject_017_gazeCodeCounts.csv")
