...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s019_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s019_part2_data.xlsx"
...
category_counts(subjnum,1,"study",178,	210)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",405,	519)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",706	,740)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",829,	925)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1083,	1116)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1263,	1410)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1544,	1577)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1706,	1833)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2018,	2051)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2132	,2284)
...
category_counts(subjnum,6,"study",68,	101)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",199	,304)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",451,	485)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",604,	711)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",868,	902)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",995,	1097)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1251,	1284)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1423,	1581)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1763,	1796)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1873	,1968)
...
sink("subject_019_gazeCodeCounts.csv")
