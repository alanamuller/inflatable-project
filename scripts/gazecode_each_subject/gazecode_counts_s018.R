...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s018_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s018_part2_data.xlsx"
...
category_counts(subjnum,1,"study",146,	181)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",266,	361)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",532	,566)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",673	,833)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1001	,1036)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1147,	1242)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1387,	1422)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1500,	1598)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1719,	1755)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1846	,1977)
...
category_counts(subjnum,6,"study",80	,114)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",227,	351)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",486	,520)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",610,	717)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",860	,895)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",999	,1123)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1252,	1286)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1384,	1534)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1695,	1729)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1803,	1994)
...
sink("subject_018_gazeCodeCounts.csv")
