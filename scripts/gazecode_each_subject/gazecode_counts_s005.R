...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s005_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s005_part2_data.xlsx"
...
category_counts(subjnum,1,"study",147,	182)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",358,	443)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",709,	742)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",836	,895)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1086,	1119)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1200,	1270)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1422,	1455)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1542,	1626)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1767,	1800)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1872,	1939)
...
category_counts(subjnum,6,"study",144,	178)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",272,	333)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",562,	595)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",679,	759)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",973,	1006)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1104,	1172)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1326,	1360)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1440,	1501)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1679,	1712)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1795,	1857)
...
sink("subject_005_gazeCodeCounts.csv")
