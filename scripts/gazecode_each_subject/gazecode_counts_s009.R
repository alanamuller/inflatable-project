...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s009_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s009_part2_data.xlsx"
...
category_counts(subjnum,1,"study",1761,	1853)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",405,	651)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",914,	953)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",1084,	1264)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1503,	1539)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1677,	1788)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1960,	1994)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",2088,	2247)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2425,	2465)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2613,	2716)
...
category_counts(subjnum,6,"study",51,	85)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",204	,284)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",453,	486)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",563,	640)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",814,	848)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",926	,1039)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1209,	1243)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1358,	1479)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1667	,1701)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1790	,1905)
...
sink("subject_009_gazeCodeCounts.csv")
