...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s025_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s025_part2_data.xlsx"
...
category_counts(subjnum,1,"study",146,	179)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",348,	565)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",746,	780)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",873,	982)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1230,	1266)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1368,	1531)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1696,	1730)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1860,	1996)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2141,	2175)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2255,	2332)
...
category_counts(subjnum,6,"study",98,	132)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",258	,335)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",490	,524)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",642,	747)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",884,	917)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1012,	1187)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1343,	1378)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1480,	1552)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1708,	1740)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1830	,1897)
...
sink("subject_025_gazeCodeCounts.csv")
