...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s013_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s013_part2_data.xlsx"
...
category_counts(subjnum,1,"study",81,	116)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",272	,369)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",572,	606)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",697,	775)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",950,	985)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1101,	1214)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1375,	1410)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1533,	1660)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",1859,	1894)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",1971,	2074)
...
category_counts(subjnum,6,"study",52,	87)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",187	,313)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",478,	512)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",601	,699)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",852	,888)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1010	,1105)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1264	,1298)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1425,	1504)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1647	,1684)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1765	,1841)
...
sink("subject_013_gazeCodeCounts.csv")
