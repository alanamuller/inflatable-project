...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s007_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s007_part2_data.xlsx"
...
category_counts(subjnum,1,"study",149,	183)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",283,	408)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",684,	723)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",869	,1004)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1165,	1209)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1289,	1399)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1656,	1692)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1849,	2062)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2245,	2284)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2419	,2551)
...
category_counts(subjnum,6,"study",159,	197)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",296,	424)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",583,	618)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",781,	894)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",1124,	1160)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1256,	1406)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1563,	1597)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1733,	1872)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",2030,	2065)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",2157,	2262)
...
sink("subject_007_gazeCodeCounts.csv")
