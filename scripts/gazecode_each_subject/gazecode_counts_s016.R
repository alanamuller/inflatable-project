...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s016_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s016_part2_data.xlsx"
...
category_counts(subjnum,1,"study",153,	189)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",381	,505)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",698,	733)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",831	,963)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1150,	1186)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1312,	1460)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1615,	1650)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1745,	1861)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2011,	2046)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2131,	2252)
...
category_counts(subjnum,6,"study",45,	81)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",205	,332)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",505	,540)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",637,	738)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",892	,928)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1046,	1183)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1323,	1359)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1474,	1590)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1803,	1839)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1923,	2080)
...
sink("subject_016_gazeCodeCounts.csv")
