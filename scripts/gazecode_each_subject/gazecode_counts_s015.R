...
data_part1 <- "D:/Nav_1stYr_project_data/GazeCode data/s015_part1_data.xlsx"
data_part2 <- "D:/Nav_1stYr_project_data/GazeCode data/s015_part2_data.xlsx"
...
category_counts(subjnum,1,"study",174	,213)
trial_1_study <- newTable

category_counts(subjnum,1,"retrieval",373,	540)
trial_1_retrieval <- newTable

category_counts(subjnum,2,"study",740	,773)
trial_2_study <- newTable

category_counts(subjnum,2,"retrieval",880,	1003)
trial_2_retrieval <- newTable

category_counts(subjnum,3,"study",1209,	1248)
trial_3_study <- newTable

category_counts(subjnum,3,"retrieval",1340,	1514)
trial_3_retrieval <- newTable

category_counts(subjnum,4,"study",1698,	1736)
trial_4_study <- newTable

category_counts(subjnum,4,"retrieval",1818,	1914)
trial_4_retrieval <- newTable

category_counts(subjnum,5,"study",2068,	2108)
trial_5_study <- newTable

category_counts(subjnum,5,"retrieval",2245,	2368)
...
category_counts(subjnum,6,"study",79,	117)
trial_6_study <- newTable

category_counts(subjnum,6,"retrieval",242,	339)
trial_6_retrieval <- newTable

category_counts(subjnum,7,"study",505	,542)
trial_7_study <- newTable

category_counts(subjnum,7,"retrieval",676,	772)
trial_7_retrieval <- newTable

category_counts(subjnum,8,"study",934	,969)
trial_8_study <- newTable

category_counts(subjnum,8,"retrieval",1046,	1153)
trial_8_retrieval <- newTable

category_counts(subjnum,9,"study",1304,	1342)
trial_9_study <- newTable

category_counts(subjnum,9,"retrieval",1442,	1538)
trial_9_retrieval <- newTable

category_counts(subjnum,10,"study",1695,	1732)
trial_10_study <- newTable

category_counts(subjnum,10,"retrieval",1802,	1882)
...
sink("subject_015_gazeCodeCounts.csv")
